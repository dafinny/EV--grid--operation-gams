...
;
*--------- EV Parameters ---------
Scalar PEV   Real power per EV  /0.007/;      
Scalar QEV   Reactive power per EV /0.00387/; 
* Number of EVs connected to buses 3 and 5
Scalar EVcount /28/;
scalar C_EV /39/;

* Update the Demand at buses 3 and 5 with EV load
Demand("3","PDem") = Demand("3","PDem") + EVcount * PEV;
Demand("3","QDem") = Demand("3","QDem") + EVcount * QEV;

Demand("5","PDem") = Demand("5","PDem") + EVcount * PEV;
Demand("5","QDem") = Demand("5","QDem") + EVcount * QEV;
...
EV_Cost = Sum(evbuses, C_EV * EVcount * PEV);
...
Display V.l, Delta.l, P.l, Q.l, Cost.l, Loss.l,EV_Cost;
...
Put ///;
Put '-------------------------------------------------------------'; Put /;
Put ' Total EV Charging Cost ($): ', EV_Cost:10:3; Put /;
Put '-------------------------------------------------------------'; Put ///;
